...
SRCREV = "4c4e8762cbec18e964b77f9fc8d3534eaf35183b"
SOMAJOR = "2"
SOMINOR = "0"
...
SYSTEMD_PACKAGES="${PN}"
SYSTEMD_SERVICE:${PN}="dfx-mgr.service dfx-mgr-fw-load.service"
...
do_install(){
	...
	install -m 0755 ${S}/src/scripts/xlnx-firmware-load ${D}${bindir}
