SUMMARY = "FreeRTOS lwIP echo server example application."
DESCRIPTION = "AMD Xilinx FreeRTOS sample application that runs a \
TCP/UDP echo server on top of the lwIP stack."
...
ESW_EXECUTABLE_NAME = "freertos_lwip_echo_server"
