...
PACKAGE_ARCH = "${@bb.utils.contains_any('DEPENDS', 'qt-gui', '${MALI_PACKAGE_ARCH}', '${DEFAULT_PACKAGE_ARCH}', d)}"
# Note: qt-gui depends on qtbase, which has a dependency on opengl, which triggers dependencies on it's users
