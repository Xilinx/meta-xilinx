# Indirectly links to libmali-xlnx, so it becomes MACHINE_ARCH specific
...
PACKAGE_ARCH = "${@bb.utils.contains_any('DEPENDS', 'gtk3+ vte', '${MALI_PACKAGE_ARCH}', '${DEFAULT_PACKAGE_ARCH}', d)}"
